...
#ifndef BEGINNER_TUTORIALS__SRV__CHANGE_OUTPUT_STRING_H_
#define BEGINNER_TUTORIALS__SRV__CHANGE_OUTPUT_STRING_H_
...
#endif  // BEGINNER_TUTORIALS__SRV__CHANGE_OUTPUT_STRING_H_
